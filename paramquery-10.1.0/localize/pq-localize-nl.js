...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      ...
      strAddColLeft: "Voeg kolom links toe",
      strAddColRight: "Voeg kolom rechts toe",
      strAddRow: "Rij toevoegen",
      strAddRowAbove: "Voeg rij hierboven toe",
      strAddRowBelow: "Voeg hieronder rij toe",
      ...
      strAND: "EN",
      strApply: "Toepassen",
      strBlanks: "(Lege plekken)",
      strBold: "Vetgedrukt",
      strBorder: "Grens",
      strBorderColor: "Rand kleur",
      strBorderStyle: "Grensstijl",
      strBottom: "Onderkant",
      strCancel: "Annuleren",
      strClear: "Duidelijk",
      ...
      strConditions: {
        ...
        notempty: "Niet leeg",
        notend: "Eindigt niet bij",
        range: "[ Bereik ]",
        regexp: "Regelmatige expressie"
      },
      strDelete: "uitgeven",
      strDeleteColumn: "Verwijder kolom",
      strDeleteRow: "Verwijder rij",
      strEdit: "opstellen",
      strExport: "Exporteren",
      strFillColor: "Opvulkleur",
      strFontSize: "Lettertypegrootte",
      strFontFamily: "Lettertype Family",
      strFormat: "Formaat",
      ...
      strRedo: "Opnieuw doen",
      strRename: "Hernoeming",
      strRight: "Rechts",
      strSearch: "Zoeken",
      ...
      strTextColor: "Tekst kleur",
      strTop: "Bovenkant",
      strTabRemove: "{0} zou permanent worden verwijderd.\r\n Weet je het zeker?",
      strTabName: "sheet{0}",
      strTabAdd: "Nieuw blad",
      strTabClose: "Verwijder laken",
      strTP_aggPane: "Aggregaten",
      strTP_colPane: "Groepskolommen",
      strTP_pivot: "Draaimodus",
      strTP_rowPane: "Groepsrijen",
      strTP_aggPH: "Drop kolommen voor aggregaten",
      strTP_colPH: "Drop kolommen voor kolomgroepering",
      strTP_rowPH: "Drop kolommen voor rijgroepering",
      strUpdate: "Update",
      strUnhide: "Zich onthouden",
      strUnderline: "Onderstrepen",
      strUndo: "Ongedaan maken",
      strUnmerge: "Ongeneeslijk",
      strVertical: "Verticaal",
      strWrap: "Wikkel tekst",
      strFormulas: {
