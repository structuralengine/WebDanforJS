...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      strLocal: "ja",
      strAdd: "追加",
      strAddColumn: "列を追加します",
      strAddColLeft: "左の左に追加します",
      strAddColRight: "列を右に追加します",
      strAddRow: "行を追加する",
      strAddRowAbove: "上記の行を追加します",
      strAddRowBelow: "以下の行を追加します",
      strAddRows: "{0}行を追加します",
      strAlignH: "水平アライメント",
      strAlignV: "垂直アライメント",
      strAll: "全て",
      strAND: "と",
      ...
      strDelete: "削除",
      strDeleteColumn: "列を削除します",
      strDeleteRow: "行を削除します",
      strEdit: "編集",
      strExport: "輸出",
      ...
      strFrozenRows: "冷凍列",
      strFullScreen: "全画面表示",
      strGroup_header: "列ごとにグループをドロップします",
      strGroup_merge: "セルを結合します",
      strGroup_fixCols: "列を修正します",
      strGroup_grandSummary: "グランドサマリー",
      strHide: "隠れる",
      strHideCols: "列を非表示にします",
      strHideRows: "行を非表示にします",
      strHorizontal: "水平",
      strInner: "内側",
      strInsertColumn: "列を挿入します",
      strInsertRow: "行を挿入します",
      strInsertRows: "{0}行を挿入します",
      strImport: "輸入",
      strImportImage: "画像をインポートします",
      strItalic: "イタリック",
      strLeft: "左",
      strLink: "リンク",
      strLoading: "ロード中",
      ...
      strSearch: "検索",
      strSelectAll: "すべて選択",
      strSelectedmatches: "{1}一致の選択{0}",
      strShowCols: "列を表示します",
      strShowRows: "行を表示します",
      strTextColor: "テキストの色",
      strTop: "上",
      strTabRemove: "{0}は永続的に削除されます。\r\n 本気ですか？",
      strTabName: "sheet{0}",
      strTabAdd: "新しいシート",
      strTabClose: "シートを取り外します",
      strTP_aggPane: "集合体",
      strTP_colPane: "グループ列",
      strTP_pivot: "ピボットモード",
      strTP_rowPane: "グループの行",
      strTP_aggPH: "集合体の列をドロップします",
      strTP_colPH: "列グループの列をドロップします",
      strTP_rowPH: "行のグループ化用の列をドロップします",
      strUpdate: "アップデート",
      strUnhide: "解放されません",
      strUnderline: "下線",
      strUndo: "元に戻します",
