...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      ...
      strAddColLeft: "Dodaj kolumnę w lewo",
      strAddColRight: "Dodaj kolumnę w prawo",
      strAddRow: "Dodaj wiersz",
      strAddRowAbove: "Dodaj wiersz powyżej",
      strAddRowBelow: "Dodaj wiersz poniżej",
      strAddRows: "Dodaj {0} wiersze",
      ...
      strLink: "Połączyć",
      strLoading: "?adowanie...",
      strLockCells: "Komórki zamka",
      strMerge: "Łączyć",
      strMenu: {
        hideCols: "Widoczne kolumny",
        filter: "Filtr",
        export: "Kolumny do eksportowania"
      },
      strName: "Nazwa",
      ...
      strRedo: "Przerobić",
      strRename: "Przemianować",
      strRight: "Prawidłowy",
      strSearch: "Szukaj",
      strSelectAll: "Zaznacz wszystko",
      ...
      strTop: "Szczyt",
      strTabRemove: "{0} zostanie usunięty na stałe.\r\n Jesteś pewny?",
      strTabName: "sheet{0}",
      strTabAdd: "Nowy arkusz",
      strTabClose: "Usuń arkusz",
      strTP_aggPane: "Kruszywa",
      strTP_colPane: "Kolumny grupowe",
      strTP_pivot: "Tryb obrotu",
      strTP_rowPane: "Rząd grupowy",
      strTP_aggPH: "Upuść kolumny dla agregatów",
      strTP_colPH: "Upuść kolumny do grupowania kolumn",
      strTP_rowPH: "Upuść kolumny do grupowania wierszy",
      strUpdate: "Aktualizacja",
      strUnhide: "Odłącz",
      strUnderline: "Podkreślać",
      strUndo: "Cofnij",
      strUnmerge: "Unmerge",
      strVertical: "Pionowy",
      strWrap: "Tekst owinięcia",
      strFormulas: {
