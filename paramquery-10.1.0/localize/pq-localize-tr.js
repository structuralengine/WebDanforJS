...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      ...
      strAddColLeft: "Sol Solum ekle",
      strAddColRight: "Sütun Sağ Ekle",
      strAddRow: "Satır ekle",
      strAddRowAbove: "Yukarıdaki satır ekle",
      strAddRowBelow: "Aşağıda Satır Ekle",
      ...
      strBold: "Gözü pek",
      strBorder: "Sınır",
      strBorderColor: "Sınır rengi",
      strBorderStyle: "Sınır stili",
      strBottom: "Alt",
      strCancel: "İptal etmek",
      strClear: "Temiz",
      strComment: "Yorum",
      strCondition: "Koşul:",
      strConditions: {
      ...
      strDeleteRow: "Sırayı sil",
      strEdit: "Düzenle",
      strExport: "İhracat",
      strFillColor: "Renk Doldur",
      strFontSize: "Yazı Boyutu",
      strFontFamily: "Font ailesi",
      strFormat: "Biçim",
      strFrozenCols: "Dondurulmuş sütunlar",
      strFrozenRows: "Dondurulmuş Sıralar",
      ...
      strHideRows: "Sıraları gizle",
      strHorizontal: "Yatay",
      strInner: "İç",
      strInsertColumn: "Sütunu ekle",
      strInsertRow: "Satır ekle",
      strInsertRows: "{0} satır ekleyin",
      strImport: "İçe aktarmak",
      strImportImage: "İçe Aktarma Resim",
      strItalic: "İtalik",
      strLeft: "Sol",
      strLink: "Bağlantı",
      strLoading: "Yükleniyor",
      strLockCells: "Kilit hücreleri",
      strMerge: "Birleştirmek",
      strMenu: {
        hideCols: "Görünür sütunlar",
        filter: "Filtre",
        export: "İhraç edilebilir sütunlar"
      },
      strName: "İsim",
      ...
      strRedo: "Yeniden yapmak",
      strRename: "Yeniden isimlendirmek",
      strRight: "Sağ",
      strSearch: "Ara",
      ...
      strTop: "Tepe",
      strTabRemove: "{0} kalıcı olarak silinir.\r\n Emin misin?",
      strTabName: "sheet{0}",
      strTabAdd: "Yeni sayfa",
      strTabClose: "Sayfa Kaldır",
      ...
      strUnhide: "Güçlendirmek",
      strUnderline: "Altını çizmek",
      strUndo: "Geri alma",
      strUnmerge: "Katlanmak",
      strVertical: "Dikey",
      strWrap: "Sarma Metni",
      strFormulas: {
