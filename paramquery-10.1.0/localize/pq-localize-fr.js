...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      strLocal: "fr",
      strAdd: "Ajouter",
      strAddColumn: "Ajouter la colonne",
      strAddColLeft: "Ajouter la colonne à gauche",
      strAddColRight: "Ajouter la colonne à droite",
      strAddRow: "Ajouter une rangée",
      strAddRowAbove: "Ajouter la ligne ci-dessus",
      strAddRowBelow: "Ajouter la ligne ci-dessous",
      ...
      strConditions: {
        ...
        gte: "Meilleur que ou égal",
        less: "Moins que",
        lte: "Moins ou égal",
        notbegin: "Ne commence pas par",
        notcontain: "Pas contient",
        notequal: "Pas égaux",
        notempty: "Pas vide",
        notend: "Ne se termine pas avec",
        range: "[ Gamme ]",
      ...
      strEdit: "Edit",
      strExport: "Exporter",
      strFillColor: "La couleur de remplissage",
      strFontSize: "Taille de police",
      strFontFamily: "Famille de polices",
      strFormat: "Format",
      strFrozenCols: "Colonnes congelées",
      strFrozenRows: "Rangées surgelées",
      strFullScreen: "Plein écran",
      strGroup_header: "Group par colonne",
      strGroup_merge: "Fusionner des cellules",
      strGroup_fixCols: "Correction des colonnes",
      strGroup_grandSummary: "Grand résumé",
      strHide: "Cacher",
      strHideCols: "Masquer les colonnes",
      strHideRows: "Cacher les lignes",
      strHorizontal: "Horizontal",
      strInner: "Intérieur",
      strInsertColumn: "Insérer la colonne",
      strInsertRow: "Insérer la ligne",
      strInsertRows: "Insérer {0} lignes",
      strImport: "Importer",
      strImportImage: "Image d'importation",
      strItalic: "Italique",
      strLeft: "Gauche",
      strLink: "Lien",
      strLoading: "Chargement",
      strLockCells: "Serrures",
      strMerge: "Fusionner",
      strMenu: {
      ...
      strShowRows: "Montrer les lignes",
      strTextColor: "Couleur de texte",
      strTop: "Haut",
      strTabRemove: "{0} serait supprimé en permanence.\r\n Es-tu sûr?",
      strTabName: "sheet{0}",
      strTabAdd: "Nouvelle feuille",
      strTabClose: "Retirer la feuille",
      strTP_aggPane: "Agrégats",
      strTP_colPane: "Colonnes de groupe",
      strTP_pivot: "Mode pivot",
      strTP_rowPane: "Rangées de groupe",
      strTP_aggPH: "Colonnes Drop pour les agrégats",
      strTP_colPH: "Colonnes Drop pour le regroupement des colonnes",
      strTP_rowPH: "Colonnes Drop pour le regroupement des lignes",
