...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      strLocal: "es",
      strAdd: "añadir",
      strAddColumn: "Añadir columna",
      strAddColLeft: "Agregar columna izquierda",
      strAddColRight: "Agregar columna a la derecha",
      strAddRow: "Añadir fila",
      strAddRowAbove: "Agregar fila arriba",
      strAddRowBelow: "Agregar fila a continuación",
      strAddRows: "Agregar {0} filas",
      strAlignH: "Alineación horizontal",
      strAlignV: "Alineamiento vertical",
      strAll: "Todo",
      strAND: "Y",
      strApply: "Aplicar",
      strBlanks: "(En blanco)",
      ...
      strImport: "Importar",
      strImportImage: "Imagen de importación",
      strItalic: "Itálico",
      strLeft: "Izquierda",
      strLink: "Enlace",
      strLoading: "Carga",
      strLockCells: "Bloquear las celdas",
      strMerge: "Unir",
      strMenu: {
      ...
      strTextColor: "Color de texto",
      strTop: "Arriba",
      strTabRemove: "{0} se eliminaría permanentemente.\r\n ¿Está seguro?",
      strTabName: "sheet{0}",
      strTabAdd: "Hoja nueva",
      strTabClose: "Eliminar la hoja",
      strTP_aggPane: "Agregados",
      strTP_colPane: "Columnas de grupo",
      strTP_pivot: "Modo pivote",
      strTP_rowPane: "Hileras grupales",
      strTP_aggPH: "Colocar columnas para agregados",
      strTP_colPH: "Columnas de caída para la agrupación de columnas",
      strTP_rowPH: "Columnas de caída para la agrupación de filas",
      strUpdate: "Actualizar",
      strUnhide: "Hides",
      strUnderline: "Subrayar",
      strUndo: "Deshacer",
      strUnmerge: "Inquietud",
      strVertical: "Vertical",
      strWrap: "Envolver texto",
      strFormulas: {
