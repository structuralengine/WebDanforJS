...
(function($) {
  ...
  var pq = $.paramquery,
    ...
    grid = pq.strings = pq.pqGrid.regional[local] = {
      strLocal: "pt",
      strAdd: "Adicionar",
      strAddColumn: "Adicione coluna",
      strAddColLeft: "Adicione a coluna à esquerda",
      strAddColRight: "Adicione a coluna à direita",
      strAddRow: "Adicionar linha",
      strAddRowAbove: "Adicione a linha acima",
      strAddRowBelow: "Adicione a linha abaixo",
      ...
      strDeleteRow: "Exclua linha",
      strEdit: "Editar",
      strExport: "Exportar",
      strFillColor: "Preencha a cor",
      ...
      strGroup_header: "Grupo de soltar por coluna",
      ...
      strInner: "Interno",
      strInsertColumn: "Insira a coluna",
      strInsertRow: "Insira a linha",
      strInsertRows: "Insira {0} linhas",
      strImport: "Importar",
      ...
      strShowRows: "Mostre linhas",
      strTextColor: "Cor do texto",
      strTop: "Principal",
      strTabRemove: "{0} seria excluído permanentemente.\r\n Tem certeza?",
      strTabName: "sheet{0}",
      strTabAdd: "Nova folha",
      strTabClose: "Remova a folha",
      strTP_aggPane: "Agregados",
      strTP_colPane: "Colunas de grupo",
      strTP_pivot: "Modo Pivot",
      strTP_rowPane: "Linhas de grupo",
      strTP_aggPH: "Soltar colunas para agregados",
      strTP_colPH: "Soltar colunas para agrupamento de colunas",
      strTP_rowPH: "Soltar colunas para agrupamento de linhas",
      strUpdate: "Atualizar",
      strUnhide: "Uncida",
