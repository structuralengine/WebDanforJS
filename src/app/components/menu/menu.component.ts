...
export class MenuComponent implements OnInit {
        ...
        this.fileToText(file)
          .then((text) => {
            ...
            if (this.save.checkVerFile(text)) {
              ...
              this.menuBehaviorSubject.setValue(basicFile.specification1.toString());
              this.menuService.checkedRadioSubject.next(basicFile.specification2);
            }
            this.open_done(modalRef);
          })
          .catch((err) => {
  ...
  public setSpecification1(i: number): void {
    ...
    if (prevSp2 !== currSp2) {
      ...
      this.menuService.checkedRadioSubject.next(currSp2 as number);
    }
