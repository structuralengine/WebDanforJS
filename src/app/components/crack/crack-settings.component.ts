  ...
  implements OnInit, OnDestroy, AfterViewInit
{
  ...
  ngAfterViewInit() {
    ...
    this.refreshSubscription = this.menuService.checkedRadio$.pipe(
  ...
  private setTitle(isManual: boolean): void {
    ...
    this.columnHeaders.push(
      ...
      {
        title: this.translate.instant(!this.basic.isR5() ? "crack-settings.env" : "crack-settings.water") +
    ...
    if(this.checkedRadioValue === undefined)
      this.checkedRadioValue = speci2 as number;
    //( 鉁�    &&  運輸機�) or フィリピン の場�
    if ((speci1 === Specification1.Rail && speci2 === Specification2.Shinkansen_H16) || speci1 === Specification1.Rail_Ph) {
    ...
    if (speci2 === Specification2.RailStd_H16 || speci2 === Specification2.RaidStd_R5) {
      this.columnHeaders.push({
